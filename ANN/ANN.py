...
class Classifier_Modeling(tf.keras.Model):
    def __init__(self):
        ...
        self.dense_PMV5 = tf.keras.layers.Dense(units=128, activation=tf.nn.leaky_relu)
        self.dense_PMV6 = tf.keras.layers.Dense(units=256, activation=tf.nn.leaky_relu)
        self.dense_PMV7 = tf.keras.layers.Dense(units=128, activation=tf.nn.leaky_relu)
        self.dense_PMV8 = tf.keras.layers.Dense(units=64, activation=tf.nn.leaky_relu)
