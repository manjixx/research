...
if __name__ == '__main__':
    ...
    '''save data'''
    np.save('../dataset/synthetic_v2/env.npy', env_data)
    np.save('../dataset/synthetic_v2/gender.npy', gender)
    np.save('../dataset/synthetic_v2/body.npy', body)
    np.save('../dataset/synthetic_v2/label.npy', y)
